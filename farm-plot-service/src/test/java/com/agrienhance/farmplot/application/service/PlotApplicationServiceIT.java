...
public class PlotApplicationServiceIT extends AbstractIntegrationTest {
        ...
        void createPlot_shouldPersistPlotAndReturnPlotResponse() {
                ...
                // When
                PlotResponse createdPlotResponse = plotApplicationService.createPlot(request, tenantId);
        ...
        void createPlot_whenFarmNotFound_shouldThrowResourceNotFoundException() {
                ...
                assertThrows(ResourceNotFoundException.class, () -> {
                        plotApplicationService.createPlot(request, tenantId);
                });
        }
        ...
        void createPlot_whenTenantIdMismatch_shouldThrowResourceNotFoundException() {
                ...
                assertThrows(ResourceNotFoundException.class, () -> {
                        plotApplicationService.createPlot(request, differentTenantId);
                });
        }
        ...
        void createOrUpdateLandTenureForPlot_shouldUpdateExistingLandTenure() {
                ...
                plotApplicationService.createOrUpdateLandTenureForPlot(plot.getPlotIdentifier(),
                                CreateOrUpdateLandTenureRequest.builder().tenureType(LandTenureType.OWNED).build(),
                                tenantId);
                entityManager.flush();
                entityManager.clear();
        ...
        void getLandTenureForPlot_whenExists_shouldReturnLandTenure() {
                ...
                PlotResponse plot = plotApplicationService.createPlot(CreatePlotRequest.builder()
                                ...
                                .plotGeometry(createTestPolygonDto(0.001, 3, 3))
                                .landTenureType(LandTenureType.CUSTOM_AGREEMENT)
                                .build(), tenantId);
                plotApplicationService.createOrUpdateLandTenureForPlot(plot.getPlotIdentifier(),
                ...
                // When
                LandTenureResponse tenureResponse = plotApplicationService.getLandTenureForPlot(
                                plot.getPlotIdentifier(),
                                tenantId);
        ...
        void deleteLandTenureForPlot_shouldDeleteAndResetPlotTenureType() {
                ...
                PlotResponse plot = plotApplicationService.createPlot(CreatePlotRequest.builder()
                                ...
                                .plotGeometry(createTestPolygonDto(0.001, 5, 5)).landTenureType(LandTenureType.OWNED) // Initially
                                                                                                                      // set
                                .build(), tenantId);
                ...
                assertThat(landTenureRepository.findByPlot_PlotIdentifierAndTenantId(plot.getPlotIdentifier(),
                                tenantId))
                                .isPresent();
        ...
        void listPlotsByFarm_shouldReturnPaginatedPlotsForCorrectFarmAndTenant() {
                ...
                plotApplicationService.createPlot(CreatePlotRequest.builder()
                                .farmIdentifier(testFarm.getFarmIdentifier())
                                .plotName("Plot Alpha (Farm1)").plotGeometry(createTestPolygonDto(0.001, 1, 1))
                                .landTenureType(LandTenureType.OWNED).build(), tenantId);
                plotApplicationService.createPlot(CreatePlotRequest.builder()
                                .farmIdentifier(testFarm.getFarmIdentifier())
                                .plotName("Plot Bravo (Farm1)").plotGeometry(createTestPolygonDto(0.001, 2, 2))
                                .landTenureType(LandTenureType.LEASED).build(), tenantId);
                plotApplicationService.createPlot(CreatePlotRequest.builder()
                                .farmIdentifier(testFarm.getFarmIdentifier())
                                .plotName("Plot Charlie (Farm1)").plotGeometry(createTestPolygonDto(0.001, 3, 3))
                                .landTenureType(LandTenureType.COMMUNAL_ACCESS).build(), tenantId);

                // Plot for another farm but same tenant (should not be listed by this method if
                // filtering by farmId)
                Farm anotherFarmSameTenant = farmRepository.saveAndFlush(Farm.builder()
                                .farmName("Another Farm, Same Tenant")
                                .ownerReferenceId(ownerId).countryCode("PL").tenantId(tenantId).build());
                plotApplicationService
                                .createPlot(CreatePlotRequest.builder()
                                                .farmIdentifier(anotherFarmSameTenant.getFarmIdentifier())
                                                .plotName("Plot Delta (Farm2)")
                                                .plotGeometry(createTestPolygonDto(0.001, 4, 4))
                                                .landTenureType(LandTenureType.OWNED).build(),
                                                tenantId);
                ...
                Page<PlotResponse> plotPage = plotApplicationService.listPlotsByFarm(testFarm.getFarmIdentifier(),
                                tenantId,
                                pageable);
        ...
        void listPlotsByFarm_whenFarmNotFoundOrTenantMismatch_shouldThrowResourceNotFound() {
                ...
                assertThrows(ResourceNotFoundException.class, () -> {
                        plotApplicationService.listPlotsByFarm(testFarm.getFarmIdentifier(), differentTenantId,
                                        pageable);
                });
        }
        ...
        void listAllPlotsForTenant_shouldReturnPaginatedPlotsForCorrectTenant() {
                ...
                plotApplicationService
                                .createPlot(CreatePlotRequest.builder()
                                                .farmIdentifier(anotherFarmSameTenant.getFarmIdentifier())
                                                .plotName("Plot B (Tenant1 Farm2)")
                                                .plotGeometry(createTestPolygonDto(0.001, 2, 2))
                                                .landTenureType(LandTenureType.LEASED).build(),
                                                tenantId);
                ...
                plotApplicationService
                                .createPlot(CreatePlotRequest.builder()
                                                .farmIdentifier(farmOtherTenant.getFarmIdentifier())
                                                .plotName("Plot C (Tenant2 FarmC)")
                                                .plotGeometry(createTestPolygonDto(0.001, 3, 3))
                                                .landTenureType(LandTenureType.OWNED).build(),
                                                otherTenantId);
                entityManager.flush();
        ...
        void updatePlot_shouldUpdatePlotDetailsAndArea() {
                ...
                assertThat(updatedPlotResponse.getPlotGeometry().getCoordinates().get(0).get(0)).containsExactly(6.0,
                                6.0); // Check
                                      // new
                                      // geometry
                                      // origin
                ...
                assertThat(dbPlot.getCalculatedAreaHectares().doubleValue())
                                .isGreaterThan(initialArea != null ? initialArea.doubleValue() : 0.0); // Assuming
                                                                                                       // larger
                                                                                                       // geometry means
                                                                                                       // larger area
        }
        ...
        void updatePlot_whenPlotNotFoundOrTenantMismatch_shouldThrowResourceNotFound() {
                ...
                assertThrows(ResourceNotFoundException.class, () -> {
                        plotApplicationService.updatePlot(existingPlot.getPlotIdentifier(), updateRequest,
                                        differentTenantId);
                });
        }
        ...
        void deletePlot_shouldRemovePlotAndAssociatedLandTenure() {
                ...
                assertThat(
                                landTenureRepository.findByPlot_PlotIdentifierAndTenantId(
                                                plotToDelete.getPlotIdentifier(), tenantId))
                                .isPresent();
